 ...
 * <ul>
 * <li>{@link org.xtext.example.xpt.xpt.impl.QueryImpl#getSteps <em>Steps</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class QueryImpl extends MinimalEObjectImpl.Container implements Query {
	...
	protected EClass eStaticClass() {
		return XptPackage.Literals.QUERY;
	}
	...
	public EList<Step> getSteps() {
		if (steps == null) {
			steps = new EObjectContainmentEList<Step>(Step.class, this, XptPackage.QUERY__STEPS);
		}
		return steps;
	}
	...
	public String queryConstruction(Map<String, Object> variables) {
		String res = "";
		Attr attribute = null;
		for (int i = 0; i < getSteps().size(); i++) {
			if (getSteps().get(i).getPlaceholder() != null) {
				res = (String) variables.get(getSteps().get(i).getPlaceholder());
			} else {
				res += '/' + getSteps().get(i).getName();
				attribute = getSteps().get(i).getAttribute();
				if (attribute != null) {
