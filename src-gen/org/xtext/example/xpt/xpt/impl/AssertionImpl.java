 ...
 * <em><b>Assertion</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.xtext.example.xpt.xpt.impl.AssertionImpl#getQuery <em>Query
 * </em>}</li>
 * <li>{@link org.xtext.example.xpt.xpt.impl.AssertionImpl#getFunction <em>
 * Function</em>}</li>
 * <li>{@link org.xtext.example.xpt.xpt.impl.AssertionImpl#getConstant <em>
 * Constant</em>}</li>
 * </ul>
 * </p>
 * 
...
public class AssertionImpl extends MinimalEObjectImpl.Container implements Assertion {
	...
	public NotificationChain basicSetQuery(Query newQuery, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XptPackage.ASSERTION__QUERY, oldQuery, newQuery);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setQuery(Query newQuery) {
		if (newQuery != query) {
			...
			if (query != null)
				msgs = ((InternalEObject) query).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XptPackage.ASSERTION__QUERY, null, msgs);
			if (newQuery != null)
				msgs = ((InternalEObject) newQuery).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XptPackage.ASSERTION__QUERY, null, msgs);
			msgs = basicSetQuery(newQuery, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XptPackage.ASSERTION__QUERY, newQuery, newQuery));
	}
	...
	@Override
	public String assertionConstruction(Map<String, Object> variables) {
		String res = "";
		if(getQuery() != null){
			res = getQuery().queryConstruction(variables);
		} else if(getConstant().getString() == null){
			res = String.valueOf(getConstant().getInt());
		} else {
			res = getConstant().getString();
		}
		if (getFunction() != null) {
			res += '.' + getFunction();
		}
